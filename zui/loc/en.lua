...
if not Z.notenglish then
  ...
  L.popup_disableui = "Zui doesn't work for this resolution, do you want to disable Zui? (Cancel if you want to try another resolution)"
  L.popup_install = "First time running Zui v"..Z.version.." with this Character. You must reload your UI to set Action Bars, Variables and Chat Frames."
  L.popup_reset = "Warning! This will reset everything to Zui default. Do you want to proceed?"
  ...
  L.core_welcome1 = "Welcome to |cffC495DDZui|r |cffFFD700(Edited)|r, "
  L.core_welcome2 = "Type |cffC495DD/uihelp|r for more info or visit www.tukui.org"
  ...
  L.core_uihelp9 = "|cffFF0000/resetui|r - Reset Zui to default."
  ...
  L.chat_bind_header = "|cffaad372ZodUI|cfffff468Chat |cffffffffBind"
  L.chat_bind_say = "Say"
  L.chat_bind_yell = "Yell"
  L.chat_bind_party = "Party"
  L.chat_bind_guild = "Guild"
  L.chat_bind_raid = "Raid"
L.chat_bind_bg = "Battleground"
  ...
  L.loot_slot_fish = "Fishy"
  L.loot_slot_empty = "Empty"
  ...
  L.hotkey_mouse = "Mouse Button "
  L.hotkey_middle = "Middle Mouse"
  L.hotkey_scrollup = "Mouse Wheel Up"
  L.hotkey_scrolldown = "Mouse Wheel Down"
  L.hotkey_numpad = "Num Pad "

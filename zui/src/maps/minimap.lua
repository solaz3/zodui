...
ZuiMinimap:SetPoint("TOPRIGHT", UIParent, "TOPRIGHT", Z.Scale(-5), Z.Scale(-5))
ZuiMinimap:SetSize(Z.Scale(144), Z.Scale(144))
ZuiMinimap:SetClampedToScreen(true)
ZuiMinimap:SetMovable(true)
ZuiMinimap.text = Z.SetFontString(ZuiMinimap, C.media.font, 12, "OUTLINE")
...
MiniMapMailIcon:SetTexture("Interface\\AddOns\\zui\\res\\tex\\mail") -- made my own mail icon 
...
m_zone_text:SetFont(C.media.font, 10, "THINOUTLINE")
...
m_coord_text:SetFont(C.media.pxfont, 12, "OUTLINEMONOCHROME")

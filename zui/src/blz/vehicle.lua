...
--------------------------------------------------------------------------
local anchor = CreateFrame("Frame", "ZuiVehicleAnchor", UIParent)
anchor:Point("BOTTOM", UIParent, "BOTTOM", -260, 170)
anchor:Size(120, 20)
...
anchor:SetAlpha(0)
anchor.text = Z.SetFontString(anchor, C.media.font, 12, "THINOUTLINE")

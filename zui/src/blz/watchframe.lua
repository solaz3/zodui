...
ZuiWatchFrameAnchor.text = Z.SetFontString(ZuiWatchFrameAnchor, C.media.font, 12, "THINOUTLINE")
...
if ZuiBar5 then
  ZuiWatchFrameAnchor:Point("TOPRIGHT", ZuiBar5, "TOPLEFT", -50, 20)
else
...
local function setup()	
	...
	WatchFrameCollapseExpandButton:FontString("text", C.media.pxfont, 12, "OUTLINEMONOCHROME")
	WatchFrameCollapseExpandButton.text:SetText("X")
	WatchFrameCollapseExpandButton.text:Point("CENTER", 1, 2)

...
local Ls = {
	fish = L.loot_slot_fish,
	empty = L.loot_slot_empty,
}
...
title:SetFont(C["media"].font, 13, "THINOUTLINE")
...
addon:SetClampRectInsets(0, 0, Z.Scale(14), 0)
addon:SetHitRectInsets(0, 0, Z.Scale(-14), 0)

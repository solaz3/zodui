...
L.popup_disableui = "ZodUI doesn't work for this resolution, do you want to disable ZodUI? (Cancel if you want to try another resolution)"
L.popup_install = "First time running ZodUI with this Character. You must reload your UI to set Action Bars, Variables and Chat Frames."
L.popup_reset = "Warning! This will reset everything to ZodUI default. Do you want to proceed?"
...
L.core_welcome1 = "Welcome to |cffC495DDZodUI|r, version "

...
if Z.client == "zhTW" then
	...
	L.popup_disableui = "ZodUI並不支援此解析度, 你想要停用ZodUI嗎? (若果您想要嘗試其他解析度, 請按取消)"
	L.popup_install = "這個角色首次使用ZodUI, 您必需先重載介面以完成設定"
	L.popup_reset = "警告! 此動作會重置任何設定至ZodUI預設值. 您是否依然決定這樣做?"
	...
	L.core_welcome1 = "歡迎使用 |cffC495DDZodUI|r "
	...
	L.core_uihelp9 = "|cffFF0000/resetui|r - 重置ZodUI到預設設置."
  ...
  L.hotkey_mouse = "滑鼠按鍵"
  L.hotkey_middle = "滑鼠中鍵"
  L.hotkey_scrollup = "滑鼠滾輪向上滾動"
  L.hotkey_scrolldown = "滑鼠滾輪向下滾動"

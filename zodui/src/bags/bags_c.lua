...
function Stuffing:CreateBagFrame(w)
  ...
  f:EnableMouse(1)
	...
	if w == "Bank" then
		f:Point("BOTTOMLEFT", ZuiChatBackgroundLeft, "TOPLEFT", 0, 3)
	else
		f:Point("BOTTOMRIGHT", ZuiChatBackgroundRight, "TOPRIGHT", 0, 3)
	end
...
function Stuffing:Layout(lb)
	...
	if lb then
		bs = bags_BANK
		if Z.InfoLeftRightWidth >= 405 then
			cols = 11
		elseif Z.InfoLeftRightWidth >= 370 and Z.InfoLeftRightWidth < 405 then
			cols = 10
		elseif Z.InfoLeftRightWidth >= 335 and Z.InfoLeftRightWidth < 370 then
			cols = 10
		else
			cols = 12
		end
...
function Stuffing:PLAYER_ENTERING_WORLD()
	...
	ContainerFrame1:Point("BOTTOMRIGHT", ZuiChatBackgroundRight, "BOTTOMRIGHT", 3, 0)

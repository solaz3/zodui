...
if C["datatext"].gold and C["datatext"].gold > 0 then
	...
	local function OnEvent(self, event)
		...
		if (ZuiData.gold == nil) then ZuiData.gold = {}; end
		if (ZuiData.gold[myPlayerRealm]==nil) then ZuiData.gold[myPlayerRealm]={}; end
		ZuiData.gold[myPlayerRealm][myPlayerName] = GetMoney();
	...
	Stat:SetScript("OnEnter", function(self)
		if not InCombatLockdown() then
			...
			local thisRealmList = ZuiData.gold[myPlayerRealm];

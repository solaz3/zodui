...
TRINKET_FILTER = {
	...
	--CreateSpellEntry( 75170 ), -- Lightweave 光紋
	CreateSpellEntry( 2825, true ), --Heroism
	CreateSpellEntry( 32182, true ), -- Bloodlust
	--CreateSpellEntry( 90355, true ), -- Hunter Pet Bloodlust  上古狂亂
  CreateSpellEntry( 19372, true), -- 3.35
	--CreateSpellEntry( 80353 ), -- Time Warp 時間扭曲
	...
	--CreateSpellEntry( 74497 ), 
  CreateSpellEntry( 55503 ), CreateSpellEntry( 55502 ), CreateSpellEntry( 55501 ), CreateSpellEntry( 55500 ), CreateSpellEntry( 55480 ), CreateSpellEntry( 55428 ), --CreateSpellEntry( 81708 ), -- Lifeblood
}

...
local panel_height = ((Z.Scale(5)*4) + (Z.Scale(20)*4))

--Create main frame
local RaidUtilityPanel = CreateFrame("Frame", "RaidUtilityPanel", UIParent)
RaidUtilityPanel:CreatePanel("Transparent", Z.Scale(230), panel_height, "TOP", TukuiTopBar, "BOTTOM", 0, -4)
...
local function CreateButton(name, parent, template, width, height, point, relativeto, point2, xOfs, yOfs, text, texture)
	...
	elseif texture then
		...
		t:SetPoint("TOPLEFT", b, "TOPLEFT", Z.mult, -Z.mult)
		t:SetPoint("BOTTOMRIGHT", b, "BOTTOMRIGHT", -Z.mult, Z.mult)	
	end
end

--Show Button
CreateButton("ShowButton", UIParent, "UIMenuButtonStretchTemplate, SecureHandlerClickTemplate", 80, 21, "TOP", TukuiTopBar, "BOTTOM", 0, -4, L.core_raidutil, nil)
...
--Disband Raid button
CreateButton("DisbandRaidButton", RaidUtilityPanel, "UIMenuButtonStretchTemplate", RaidUtilityPanel:GetWidth() * 0.8, E.Scale(18), "TOP", RaidUtilityPanel, "TOP", 0, Z.Scale(-5), L.core_raidutil_disbandgroup, nil)
...
--Role Check button
CreateButton("RoleCheckButton", RaidUtilityPanel, "UIMenuButtonStretchTemplate", RaidUtilityPanel:GetWidth() * 0.8, Z.Scale(18), "TOP", DisbandRaidButton, "BOTTOM", 0, Z.Scale(-5), ROLE_POLL, nil)
...
--MainTank Button
CreateButton("MainTankButton", RaidUtilityPanel, "SecureActionButtonTemplate, UIMenuButtonStretchTemplate", (DisbandRaidButton:GetWidth() / 2) - Z.Scale(2), Z.Scale(18), "TOPLEFT", RoleCheckButton, "BOTTOMLEFT", 0, Z.Scale(-5), MAINTANK, nil)
MainTankButton:SetAttribute("type", "maintank")
MainTankButton:SetAttribute("unit", "target")
MainTankButton:SetAttribute("action", "toggle")

--MainAssist Button
CreateButton("MainAssistButton", RaidUtilityPanel, "SecureActionButtonTemplate, UIMenuButtonStretchTemplate", (DisbandRaidButton:GetWidth() / 2) - Z.Scale(2), Z.Scale(18), "TOPRIGHT", RoleCheckButton, "BOTTOMRIGHT", 0, Z.Scale(-5), MAINASSIST, nil)
MainAssistButton:SetAttribute("type", "mainassist")
MainAssistButton:SetAttribute("unit", "target")
MainAssistButton:SetAttribute("action", "toggle")

--Ready Check button
CreateButton("ReadyCheckButton", RaidUtilityPanel, "UIMenuButtonStretchTemplate", RoleCheckButton:GetWidth() * 0.75, Z.Scale(18), "TOPLEFT", MainTankButton, "BOTTOMLEFT", 0, Z.Scale(-5), READY_CHECK, nil)
...
CompactRaidFrameManagerDisplayFrameLeaderOptionsRaidWorldMarkerButton:SetPoint("TOPRIGHT", MainAssistButton, "BOTTOMRIGHT", 0, Z.Scale(-5))
CompactRaidFrameManagerDisplayFrameLeaderOptionsRaidWorldMarkerButton:SetParent("RaidUtilityPanel")
CompactRaidFrameManagerDisplayFrameLeaderOptionsRaidWorldMarkerButton:SetHeight(Z.Scale(18))

...
local TEXTURE = C["media"].glossTex
local FONT = C["media"].font
local NFONT = C["media"].numfont
local FONTSIZE = 10
...
if C["nameplate"].overlap == true or Z.eyefinity then
...
local function SkinObjects(frame)
	...
	hp.level:SetFont(NFONT, FONTSIZE, FONTFLAG)
	...
	if C["nameplate"].showhealth == true then
		...
		hp.value:SetFont(NFONT, FONTSIZE, FONTFLAG)
	...
	cb.time:SetFont(NFONT, FONTSIZE, FONTFLAG)
